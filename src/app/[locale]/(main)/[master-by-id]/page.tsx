...
export default function MasterProfilePage() {
	const t = useTranslations('masterByid')
				...
				<Card>
					...
					<CardContent>
						...
						<div className='mt-8 pt-6 border-t border-gray-200'>
							<h3 className='text-lg font-semibold mb-4'>{t('8')}</h3>

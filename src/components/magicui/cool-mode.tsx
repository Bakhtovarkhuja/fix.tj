...
export const CoolMode: React.FC<CoolModeProps> = ({ children, options }) => {
  ...
  // Прокидываем ref только если children — DOM-элемент
  // Если children — кастомный компонент без forwardRef — будет ошибка.
  // Поэтому нужно гарантировать, что children — ReactElement DOM-элемента (div, span, и т.п.)
